...
# Determining the number of parameters included in the optimization
NumOptPrms=0
for i in $param_bol[@]
do
  if $i; then
    NumOptPrms=$(( $NumOptPrms+1 ))
  fi
done

# Reading the optimized values from the file
for i in {1..$NumOptPrms}
do
  line=(`head -$(( $i+1 )) $PrmFl |tail -1`)
...
p_eps0=$(( $param_val[$cnt]*0.007+0.04 ))
cnt=$(( $cnt+1 ))
...
p_epsR6=$(( $param_val[$cnt]*0.0001+0.0005 ))
cnt=$(( $cnt+1 ))
...
p_pe_R1c=$(( $param_val[$cnt]*0.5+0.5 ))
cnt=$(( $cnt+1 ))
...
p_pe_R1n=$(( $param_val[$cnt]*0.5+0.5 ))
cnt=$(( $cnt+1 ))
...
p_pe_R1p=$(( $param_val[$cnt]*0.5+0.5 ))
cnt=$(( $cnt+1 ))
...
p_srs=$(( $param_val[$cnt]*0.05+0.025 ))
cnt=$(( $cnt+1 ))
...
p_sdmo=$(( $param_val[$cnt]+0.05+0.025 ))
cnt=$(( $cnt+1 ))
...
p_pu_ea=$(( $param_val[$cnt]*0.05+0.025 ))
cnt=$(( $cnt+1 ))
...
p_pu_ra=$(( $param_val[$cnt]*0.05+0.025 ))
cnt=$(( $cnt+1 ))
...
p_qun=$(( $param_val[$cnt]*0.025+0.0125 ))
cnt=$(( $cnt+1 ))
...
p_qnlc=$(( $param_val[$cnt]*0.00687+0.003435 ))
cnt=$(( $cnt+1 ))
...
p_qncPPY=$(( $param_val[$cnt]*0.0126+0.0063 ))
cnt=$(( $cnt+1 ))
...
p_qup=$(( $param_val[$cnt]*0.0025+0.00125 ))
cnt=$(( $cnt+1 ))
...
p_qplc=$(( $param_val[$cnt]*0.000429+0.0002145 ))
cnt=$(( $cnt+1 ))
...
p_qpcPPY=$(( $param_val[$cnt]*0.000786+0.000393 ))
cnt=$(( $cnt+1 ))
...
p_esNI=$(( $param_val[$cnt]*0.75+0.25 ))
cnt=$(( $cnt+1 ))
...
p_alpha_chl=$(( $param_val[$cnt]*0.0000152+0.0000076 ))
cnt=$(( $cnt+1 ))
...
p_qlcPPY=$(( $param_val[$cnt]*0.016+0.008 ))
cnt=$(( $cnt+1 ))
...
p_epsChla=$(( $param_val[$cnt]*0.03+0.015 ))
cnt=$(( $cnt+1 ))
...
z_sdo=$(( $param_val[$cnt]*0.25+0.125 ))
cnt=$(( $cnt+1 ))
...
z_pu_ea=$(( $param_val[$cnt]*0.25+0.125 ))
cnt=$(( $cnt+1 ))
...
z_chuc=$(( $param_val[$cnt]*400.0+100.0 ))
cnt=$(( $cnt+1 ))
...
z_minfood=$(( $param_val[$cnt]*50.0+25.0 ))
cnt=$(( $cnt+1 ))
...
z_qpcMIZ=$(( $param_val[$cnt]*0.0002+0.0007 ))
cnt=$(( $cnt+1 ))
...
z_qncMIZ=$(( $param_val[$cnt]*0.01+0.01 ))
cnt=$(( $cnt+1 ))
...
p_sN4N3=$(( $param_val[$cnt]*0.01+0.005 ))
cnt=$(( $cnt+1 ))
...
p_clO2o=$(( $param_val[$cnt]*10.0+5.0 ))
cnt=$(( $cnt+1 ))
...
p_sR6O3=$(( $param_val[$cnt]*0.4+0.05 ))
cnt=$(( $cnt+1 ))
...
p_sR6N1=$(( $param_val[$cnt]*0.4+0.05 ))
cnt=$(( $cnt+1 ))
...
p_sR6N4=$(( $param_val[$cnt]*0.4+0.05 ))
...
p_sR1O3=$(( $param_val[$cnt]*0.4+0.05 ))
cnt=$(( $cnt+1 ))
...
p_sR1N1=$(( $param_val[$cnt]*0.4+0.05 ))
cnt=$(( $cnt+1 ))
...
p_sR1N4=$(( $param_val[$cnt]*0.4+0.05 ))
cnt=$(( $cnt+1 ))
