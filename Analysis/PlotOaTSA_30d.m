...
% model solution. This script uses daily values from the first thirty     %
% days of the simulation to calculate the RMSD for the objective          %
% function.                                                               %
%                                                                         %
